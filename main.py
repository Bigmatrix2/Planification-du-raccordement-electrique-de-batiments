...
def parse_args():
    ...
    p.add_argument("--arbre", default="clientnv/reseau_en_arbre.xlsx", help="Chemin du fichier arbre Excel")
    p.add_argument("--infra", default="clientnv/infra.csv", help="Chemin du CSV des infrastructures")
    p.add_argument("--bats",  default="clientnv/batiments.csv", help="Chemin du CSV des bâtiments")
